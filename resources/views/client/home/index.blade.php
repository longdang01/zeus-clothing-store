                    ...
                    <div class="tab-pane fade show active" id="blog-first-time">
                        <div class="blog__slide owl-carousel owl-theme">
                            <div class="item">
                                <div class="blog__wrap">
                                    <a href="#" class="blog__wrap-img">
                                        <img class="blog__img" src="./upload/news/_MG_4960.jpg">
                                    </a>
        
                                    <div class="blog__wrap-info">
                                        <p class="blog__wrap-info-time">19 tháng 03, 2022</p>
                                        <a href="#" class="blog__wrap-info-name">QUI TRÌNH SẢN XUẤT SƠ MI CUBAN TẠI ZEUS</a>      
                            ...
                            <div class="item">
                                <div class="blog__wrap">
                                    <a href="#" class="blog__wrap-img">
                                        <img class="blog__img" src="./upload/news/homeStay3.jpg">
                                    </a>
        
                                    <div class="blog__wrap-info">
                                        <p class="blog__wrap-info-time">19 tháng 03, 2022</p>
                                        <a href="#" class="blog__wrap-info-name">ĐỊA ĐIỂM CỬA HÀNG Ở ĐÂU?</a>      
                                        <a href="#" class="btn-read">Đọc thêm</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="blog__wrap">
                                    <a href="#" class="blog__wrap-img">
                                        <img class="blog__img" src="./upload/news/photo-1504326787394-e6d75cae8027.jpg">
                                    </a>
        
                                    <div class="blog__wrap-info">
                                        <p class="blog__wrap-info-time">19 tháng 03, 2022</p>
                                        <a href="#" class="blog__wrap-info-name">CHÍNH SÁCH KHÁCH HÀNG NHƯ THẾ NÀO?</a>      
                                        <a href="#" class="btn-read">Đọc thêm</a>
                                    </div>
                                </div>
                            </div>

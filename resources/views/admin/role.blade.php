...
@section('content')
<div class="content-wrapper" ng-controller="role">
    ...
    <section class="content">
      ...
      <table class="table">
          ...
          <tbody>
            <tr dir-paginate="item in roles|itemsPerPage:5|filter: keyword">
              <td>@{{$index+1}}</td>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input style="height: 60px;" type="text" class="form-control" ng-model="role.description">
                            </div>
                        </div>
                    </div>
...
@stop
@section('js')
<script src="/assets/admin/dist/js/rolecontroller.js"></script>
@stop

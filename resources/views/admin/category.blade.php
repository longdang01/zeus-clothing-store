...
@section('content')
<div class="content-wrapper" ng-controller="category">
    ...
    <section class="content">
      ...
      <table class="table">
          ...
          <tbody>
            <tr dir-paginate="item in categories|itemsPerPage:5">
              <td>@{{$index+1}}</td>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input style="height: 60px;" type="text" class="form-control" ng-model="category.description">
                            </div>
                        </div>
                    </div>
...
@stop
@section('js')
<script src="/assets/admin/dist/js/categorycontroller.js"></script>
@stop

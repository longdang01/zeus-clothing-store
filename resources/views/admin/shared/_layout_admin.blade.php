...
<head>
  ...
  <style>
      ...
      .dropdrown-user.image:hover .dropdrown-user.dropdown-menu{
        display: block;
      }
  </style>
</head>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block" ng-controller="search">
          <form class="form-inline">
            <div class="input-group input-group-sm">
              <input id="search-input" class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" ng-modal="keyword_search">
              <div class="input-group-append">
                <button class="btn btn-navbar" type="submit">
                  <i class="fas fa-search" ng-click="search()"></i>
                </button>
                <button class="btn btn-navbar" type="button" data-widget="navbar-search" ng-click="cancer_search()">
      ...
      <li class="nav-item">
        <button type="button" id="btn-logout" class="btn btn-light">Logout</button>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Huy - Long</span>
    </a> -->
...
<script>
    ...
    app.controller('search', function($scope,$rootScope){
      $rootScope.keyword_search = "";
      $scope.search = function (){
        $rootScope.keyword_search=$("#search-input")[0].value;
      }
      $scope.cancer_search = function (){
        $rootScope.keyword_search = "";
      }
    })
    ...
    app.controller('sidebar', function($scope,$rootScope){
      $('.nav-item.big-item').click(function(){
        $('.nav-item.big-item .active').removeClass('active');
        console.log($(this).find('.nav-link.big-link'));
        $(this).find('.nav-link.big-link').addClass('active');
      })
    })
</script>
